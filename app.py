...
with tab_compare:
    ...
    st.info(
        ...
        "for the same WWTP, event and substance."
    )
    ...
    if len(comparison) > 0:
        ...
        if len(comparison_plot) > 0:
            ...
            fig_increase_before = px.bar(
                comparison_plot.dropna(subset=["Increase_vs_Before_%"]),
                x="Substance",
                y="Increase_vs_Before_%",
                color="City",
                facet_col="Event",
                hover_data=[
                    "State", "City", "WWTP",
                ...
                title="Percentage increase from Before to During period",
                labels={"Increase_vs_Before_%": "Increase vs Before (%)"}
            )

            st.plotly_chart(fig_increase_before, use_container_width=True)
            ...
            empty_message(
                "Reference and During periods were not both available for the selected filters."
            )
